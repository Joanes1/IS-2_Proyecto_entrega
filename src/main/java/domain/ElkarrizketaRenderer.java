...
public class ElkarrizketaRenderer extends JLabel{
	...
	private Boolean bool;
	 public ElkarrizketaRenderer(User u) {
	    ...
	    public Component getListCellRendererComponent(JList<? extends ElkarrizketaContainer> list, ElkarrizketaContainer elkarrizketa, 
