...
public class BLFacadeImplementation  implements BLFacade {
   ...
   public Question createQuestion(Event event, String question, float betMinimum) throws EventFinished, QuestionAlreadyExist{
    ...
    public void DiruaSartu(User u, Double dirua, String mota) {
    	Date data = new Date();
    	dbManager.open(false); 
    	dbManager.DiruaSartu(u, new DiruaSartuParameter(dirua, data, mota));
    	dbManager.close();
    }
    @WebMethod	
    ...
    @WebMethod
	public boolean mezuaBidali(Participantes p, String titulo, String test, Elkarrizketa m) {
		dbManager.open(false);
		Boolean ema = dbManager.mezuaBidali(p, titulo, test, m);
		dbManager.close();
		return ema;
	}
